...
public class linkedlist {
	...
	{
		LinkedOperations LinkedOperations=new LinkedOperations();
			...
			while(true)
			{
				...
				switch(n) {
					case 1 :
						...
						int beg=sc.nextInt();
						LinkedOperations.insertAtBeginning(beg);
						break;
					case 2 :
						System.out.println("Enter the value to be inserted at end : ");
						int end=sc.nextInt();
						LinkedOperations.insertAtLast(end);
						break;
					case 3 :
						...
						int pos=sc.nextInt();
						LinkedOperations.insertAtMiddle(mid,pos);
						break;
					case 4 :
						LinkedOperations.deleteAtBeginning();
						break;
					case 5 :
						LinkedOperations.deleteAtLast();
						break;
					case 6:
						System.out.println("Enter the value to be delete to a specified position : ");
						int pos1=sc.nextInt();
						LinkedOperations.deleteAtMiddle(pos1);
						break;
					case 7 :
						System.out.println("Enter the value to be searched : ");
						int srch=sc.nextInt();
						LinkedOperations.search(srch);
						break;
					case 8 :
						LinkedOperations.display();
						break;
					case 9 :
						LinkedOperations.countNode();
						break;
					default:
